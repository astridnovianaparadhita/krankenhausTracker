    ...
    mapDemo.Directions = (function() {
        function _Directions() {
            var map,
                    ...
                    markerA = new google.maps.MarkerImage('assets/images/m1.png',
                            new google.maps.Size(24, 27),
                            new google.maps.Point(0, 0),
                            new google.maps.Point(12, 27)),
                    markerB = new google.maps.MarkerImage('assets/images/m2.png',
            ...
            autoCompleteSetup = function() {
                ...
                autoDest = new google.maps.places.Autocomplete($Selectors.dirDst);
                    ...
                    mapSetup = function() {
                        map = new google.maps.Map($Selectors.mapCanvas, {
                            zoom: 13,
                            center: new google.maps.LatLng(-7.589209, 110.8190335),
                            mapTypeControl: true,
                    ...
                    directionsRender = function(source, destination) {
                        ...
                        directionsService.route(request, function(response, status) {
                            if (status == google.maps.DirectionsStatus.OK) {
                                ...
                                pinA = new google.maps.Marker({position: _route.start_location, map: map}),
                                pinB = new google.maps.Marker({position: _route.end_location, map: map});
                            }
                        });
                    ...
                    invokeEvents = function() {
                        ...
                        $Selectors.paneToggle.toggle(function(e) {
                            $Selectors.dirPanel.animate({'left': '-=25%'});
                            jQuery(this).html('&gt;');
                        }, function() {
                            $Selectors.dirPanel.animate({'left': '+=25%'});
                            jQuery(this).html('&lt;');
